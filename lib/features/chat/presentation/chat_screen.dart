        ...
        child: Column(
          ...
          children: [
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  ChatMessageBubble(
                    key: ValueKey<String>('chat-message-character-1'),
                    alignmentKey: ValueKey<String>(
                      'chat-message-character-align',
                    ),
                    avatarKey: ValueKey<String>(
                  ...
                  ChatMessageBubble(
                    key: ValueKey<String>('chat-message-user-1'),
                    alignmentKey: ValueKey<String>('chat-message-user-align'),
            ...
            Padding(
              ...
              child: ChatInputBar(
                key: ValueKey<String>('chat-input-bar'),
