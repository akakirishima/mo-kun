    ...
    MethodChannel.MethodCallHandler
{
            ...
            switch (call.method) {
                ...
                case "setup": {
                    ...
                    if (Build.VERSION.SDK_INT >= 23) { // Android 6 (Marshmallow) and above
                        int usage = resolveUsage(androidAudioUsage);
                        int contentType = resolveContentType(androidAudioContentType);
                        ...
                        mAudioTrack = new AudioTrack(
                            resolveLegacyStreamType(androidAudioUsage),
                            sampleRate,
                            channelConfig,
    ...
    private int resolveUsage(String usage) {
        if ("voiceCommunication".equals(usage)) {
    ...
    private int resolveLegacyStreamType(String usage) {
        if ("voiceCommunication".equals(usage)) {
