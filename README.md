...
`Hello new me` は、日々の会話、音声、写真、振り返りをもとに、ユーザー自身を投影した AI キャラクターが変化していく自己育成アプリです。
...
`Hello new me` では、ユーザーの入力を単なるログではなく、内面を映す AI キャラクター、日記、翌朝のひとこと、部屋の小物、画像の雰囲気に変換します。
