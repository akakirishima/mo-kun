...
const config: AppConfig = {
  ...
  dailySummaryTemperature: 0.35,
  dailySummaryMaxOutputTokens: 320,
  dailySummaryThinkingBudget: 128,
  dailyBubbleTemperature: 0.45,
  dailyBubbleMaxOutputTokens: 120,
  dailyBubbleThinkingBudget: 32,
